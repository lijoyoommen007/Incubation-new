...
function Regester() {
    ...
    return (
        <div className='flex h-screen justify-center items-center '>
            <div className="p-4 w-full max-w-sm text-white bg-gradient-to-br from-blue-500 to-blue-900 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 shadow-md sm:p-6 md:p-8 rounded-2xl mx-3">

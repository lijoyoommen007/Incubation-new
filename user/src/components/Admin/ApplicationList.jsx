            ...
            <section className='mt-24'>
                <div className="flex justify-center flex-col items-center">
                    ...
                    <div className="p-3 mt-3 mb-5 " >
                        <h4 className=" text-start text-xl text-purple-400 font-bold uppercase">new <span className='text-white'>applicant list</span> </h4>
                    ...
                    <div className="p-3 mt-3 mb-5 " >
                        <h4 className=" text-start text-xl text-purple-400 font-bold uppercase">Pending <span className='text-white'>applicant list</span> </h4>
                        <Table className=" text-sm text-left text-gray-500 dark:text-gray-400 " >
                            <Thead className='text-sm text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400'>
                                <Tr>
                                    <Th scope="col" className='py-3 px-7'>S.no</Th>
